...
2. အပေါ်က **Deploy** ခလုတ်နှိပ်ပါ (သို့) [Vercel Import](https://vercel.com/new/clone?repository-url=https://github.com/JobForJoblessMyanmar/jfjm-job-universe)
...
| `BETTER_AUTH_URL` | ပထမ deploy ပြီးမှ `https://YOUR.vercel.app` |
...
Login = email + password။ `DATABASE_URL` မထည့်ရင် Vercel မှာ data မရပါ။

Repo: https://github.com/JobForJoblessMyanmar/jfjm-job-universe
